...
const contactInfo = [
	{
		// ícone local em public/icons (se existir)
		iconPath: "/icons/Morada.gif",
		icon: MapPin,
		label: "Morada",
		value: "Rua Dr. João Semana nº175\n3880-067 Ovar",
	},
	{
		iconPath: "/icons/Telefone.gif",
		icon: Phone,
		label: "Telefone",
	...
	return (
		<section id="contacto" className="py-20 bg-neutral-cream">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-10 rounded-2xl border border-primary/20 bg-primary/5 px-6 py-5 md:flex md:items-center md:justify-between gap-4">
					<div>
						<p className="text-sm font-semibold text-primary uppercase tracking-wider mb-1">
							Contacto rápido
						</p>
						<p className="text-neutral-dark text-sm">
							Prefere falar já? Ligue ou envie mensagem no WhatsApp antes de
					...
					<div className="flex flex-wrap gap-3">
						<a
							href="tel:+351919107717"
							className="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary/40"
						>
							Ligar agora
						</a>
						<a
									...
									return (
										<div key={info.label} className="flex gap-4">
															<div className="w-14 h-14 flex items-center justify-center flex-shrink-0">
																{"iconPath" in info && info.iconPath ? (
																	<img
																		src={assetPath(info.iconPath)}
																		alt={info.label}
											...
											<div className="min-w-0">
												...
												{"href" in info && info.href ? (
													...
													<address className="not-italic text-neutral-dark font-medium whitespace-pre-line text-sm">
														{info.value}
													</address>
												) : (
